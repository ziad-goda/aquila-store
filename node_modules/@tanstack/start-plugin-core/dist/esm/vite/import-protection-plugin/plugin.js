import { SERVER_FN_LOOKUP, VITE_ENVIRONMENT_NAMES } from "../../constants.js";
import { escapeRegExp, resolveViteId } from "../../utils.js";
import { hasIdQueryFlag } from "../module-id.js";
import { IMPORT_PROTECTION_DEBUG, MOCK_BUILD_PREFIX, VITE_BROWSER_VIRTUAL_PREFIX } from "../../import-protection/constants.js";
	...
	*/
	function getPostTransformImports(env, file) {
		...
		if (keySet) for (const k of keySet) {
			if (hasIdQueryFlag(k, "server-fn-module-lookup")) continue;
