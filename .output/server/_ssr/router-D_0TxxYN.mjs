...
const appCss = "/assets/styles-DUco05t0.css";
...
function CartProvider({ children }) {
  ...
  const addItem = (item) => {
    setItems((prev) => {
      ...
      if (existing) {
        return prev.map(
          (i) => i === existing ? { ...i, quantity: i.quantity + item.quantity } : i
        );
      }
      return [...prev, item];
    });
  ...
  const removeItem = (productId, size, color) => {
    setItems(
      (prev) => prev.filter((i) => !(i.productId === productId && i.size === size && i.color === color))
    );
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CartContext.Provider, { value: { items, addItem, removeItem, updateQuantity, clearCart, total, count }, children });
}
const useCart = () => {
...
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-8xl font-bold gradient-gold-text", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 text-xl font-semibold text-foreground", children: "الصفحة غير موجودة" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "الصفحة التي تبحث عنها غير متوفرة أو تم نقلها." }),
...
function ErrorComponent({ error, reset }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-semibold tracking-tight text-foreground", children: "حدث خطأ غير متوقع" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "يرجى المحاولة مرة أخرى أو العودة للرئيسية." }),
...
const $$splitComponentImporter$9 = () => import("./index-c92lqv6b.mjs");
const Route$9 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "اكتشف مجموعة Aquila الحصرية من الهوديز والبناطيل الفاخرة. تصاميم عصرية بلمسة ذهبية."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./about-ByliGFG9.mjs");
const Route$8 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "تعرّف على قصة Aquila، علامة الستريت وير الفاخرة التي تجمع بين الأناقة والقوة."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./account-lJgG5h0i.mjs");
...
const $$splitComponentImporter$6 = () => import("./admin-BVW85mQH.mjs");
const Route$6 = createFileRoute("/admin")({
  head: () => ({
    meta: [{
      title: "لوحة التحكم — Aquila"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./auth-BGwwl9hA.mjs");
...
const Route$5 = createFileRoute("/auth")({
  ...
  head: () => ({
    meta: [{
      title: "تسجيل الدخول — Aquila"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./cart-D-NO-WxC.mjs");
...
const $$splitComponentImporter$3 = () => import("./checkout-C-ABirdM.mjs");
const Route$3 = createFileRoute("/checkout")({
  head: () => ({
    meta: [{
      title: "إتمام الطلب — Aquila"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./contact-BmpWuMJB.mjs");
const Route$2 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      title: "تواصل معنا — Aquila"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./shop-Dy6njpvj.mjs");
const searchSchema = objectType({
  category: enumType(["hoodies", "pants"]).optional()
});
const Route$1 = createFileRoute("/shop")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "تسوّق مجموعة Aquila الكاملة من الهوديز والبناطيل الفاخرة."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./products._id-DdbSUqTH.mjs");
const Route = createFileRoute("/products/$id")({
...
const ShopRoute = Route$1.update({
  id: "/shop",
  path: "/shop",
  getParentRoute: () => Route$a
});
const ProductsIdRoute = Route.update({
  id: "/products/$id",
  path: "/products/$id",
  getParentRoute: () => Route$a
});
